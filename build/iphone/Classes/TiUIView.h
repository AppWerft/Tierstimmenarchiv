...
/**
 Base class for all Tierstimmenarchiv views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Tierstimmenarchiv view hierarchy (such as wrapped iOS UIViews) was touched.
