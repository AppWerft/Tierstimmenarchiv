...
//@interface TierstimmenarchivObject : NSObject
//@end

@interface TierstimmenarchivObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TierstimmenarchivObject class]])
		{
			for (NSString *key in [[(TierstimmenarchivObject*)o modules] allKeys])
			{
