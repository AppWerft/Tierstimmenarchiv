...
@interface TierstimmenarchivObject : KrollCoverageObject {
#else
@interface TierstimmenarchivObject : KrollObject {
#endif
@private
...
extern NSString * Tierstimmenarchiv$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TierstimmenarchivObject *_tierstimmenarchiv;
    KrollObject* console;
	BOOL shutdown;
