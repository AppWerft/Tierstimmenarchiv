 ...
 * to send analytic data that can be viewed on the Tierstimmenarchiv Dashboard.
 *
 * For information on getting started with Tierstimmenarchiv Platform Services,
