...
//Rare exceptions to indicate a bug in the _tierstimmenarchiv code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Tierstimmenarchiv proxies.
 */
