...
// in simulator we redefine to format for Tierstimmenarchiv Developer console
...
{\
	NSString * exceptionName = [@"org.tierstimmenarchiv." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tierstimmenarchiv";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITierstimmenarchivNativeItemNone = -1, 
	UITierstimmenarchivNativeItemSpinner = -2,
	UITierstimmenarchivNativeItemProgressBar = -3,
	
	UITierstimmenarchivNativeItemSlider = -4,
	UITierstimmenarchivNativeItemSwitch = -5,
	UITierstimmenarchivNativeItemMultiButton = -6,
	UITierstimmenarchivNativeItemSegmented = -7,
	
	UITierstimmenarchivNativeItemTextView = -8,
	UITierstimmenarchivNativeItemTextField = -9,
	UITierstimmenarchivNativeItemSearchBar = -10,
	
	UITierstimmenarchivNativeItemPicker = -11,
	UITierstimmenarchivNativeItemDatePicker = -12,
	
	UITierstimmenarchivNativeItemInfoLight = -13,
	UITierstimmenarchivNativeItemInfoDark = -14,
	
	UITierstimmenarchivNativeItemDisclosure = -15,
	
	UITierstimmenarchivNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Tierstimmenarchiv instances of
