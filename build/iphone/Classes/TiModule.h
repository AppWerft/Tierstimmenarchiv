...
/**
 The base class for all Tierstimmenarchiv modules
 */
...
/**
 Tierstimmenarchiv Platform calls this method on startup.
 */
-(void)startup;

/**
 Tierstimmenarchiv Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Tierstimmenarchiv Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Tierstimmenarchiv Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Tierstimmenarchiv Platform calls this method on resume.
 @param sender The sender of the event.
 */
